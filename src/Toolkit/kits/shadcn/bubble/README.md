...
<twig:Bubble:Group>
    <twig:Bubble>
        <twig:Bubble:Content>First message.</twig:Bubble:Content>
    </twig:Bubble>
    <twig:Bubble>
        <twig:Bubble:Content>Second message.</twig:Bubble:Content>
    </twig:Bubble>
</twig:Bubble:Group>
```
...
<div class="flex w-full max-w-sm flex-col gap-8 py-12">
    ...
    <twig:Bubble:Group>
        <twig:Bubble variant="tinted" align="end">
            <twig:Bubble:Content as="button" type="button">I forgot my password</twig:Bubble:Content>
        </twig:Bubble>
        <twig:Bubble variant="tinted" align="end">
            <twig:Bubble:Content as="button" type="button">I need help with my subscription</twig:Bubble:Content>
        </twig:Bubble>
        <twig:Bubble variant="tinted" align="end">
...
<div class="flex w-full max-w-sm flex-col gap-4 py-12">
    ...
    <twig:Bubble align="end">
        ...
        <twig:Bubble:Reactions class="p-0">

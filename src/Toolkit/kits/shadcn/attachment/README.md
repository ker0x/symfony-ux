...
<div class="mx-auto w-full max-w-sm">
    <twig:Attachment:Group class="w-full">
        <twig:Attachment orientation="vertical">
            ...
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove workspace.png">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
        ...
        <twig:Attachment orientation="vertical">
            ...
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove desk-reference.jpg">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
            <twig:Attachment:Trigger
        ...
        <twig:Attachment orientation="vertical">
            ...
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove office-reference.jpg">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
            <twig:Attachment:Trigger
...
<div class="mx-auto w-full max-w-sm">
    <twig:Attachment:Group class="w-full">
        <twig:Attachment class="w-64">
            ...
            <twig:Attachment:Content>
                <twig:Attachment:Title>briefing-notes.pdf</twig:Attachment:Title>
                <twig:Attachment:Description>PDF · 1.4 MB</twig:Attachment:Description>
            </twig:Attachment:Content>
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove briefing-notes.pdf">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
        </twig:Attachment>
        <twig:Attachment class="w-64">
            <twig:Attachment:Media variant="image">
                <img src="https://images.unsplash.com/photo-1497366754035-f200968a6e72?w=900&auto=format&fit=crop&q=80" alt="workspace.png" />
            </twig:Attachment:Media>
            <twig:Attachment:Content>
                <twig:Attachment:Title>workspace.png</twig:Attachment:Title>
                <twig:Attachment:Description>PNG · 820 KB</twig:Attachment:Description>
        ...
        <twig:Attachment class="w-64">
            <twig:Attachment:Media>
                <twig:ux:icon name="lucide:table" />
            </twig:Attachment:Media>
            <twig:Attachment:Content>
                <twig:Attachment:Title>customers.csv</twig:Attachment:Title>
                <twig:Attachment:Description>CSV · 18 KB</twig:Attachment:Description>
            </twig:Attachment:Content>
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove customers.csv">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
        </twig:Attachment>
        <twig:Attachment class="w-64">
            ...
            <twig:Attachment:Content>
                <twig:Attachment:Title>renderer.tsx</twig:Attachment:Title>
                <twig:Attachment:Description>TSX · 12 KB</twig:Attachment:Description>
            </twig:Attachment:Content>
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="Remove renderer.tsx">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
        </twig:Attachment>
...
<div class="flex w-full flex-col items-center gap-8">
    ...
    <div class="flex w-full max-w-sm flex-col gap-3" dir="rtl">
        <twig:Attachment orientation="vertical" class="w-full">
            ...
            <twig:Attachment:Actions>
                <twig:Attachment:Action aria-label="הסר את workspace.png">
                    <twig:ux:icon name="lucide:x" />
                </twig:Attachment:Action>
            </twig:Attachment:Actions>
        </twig:Attachment>
